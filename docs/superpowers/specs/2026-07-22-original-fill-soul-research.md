...
> 日期：2026-07-22 · 方法：Exa + GitHub 检索 · 证据：`goal/research-sources.md`
...
| 候选截断 | 字典序 24/96、tags 80 | 可用性有；**非语义检索** | **缺口** |
| 检索 | tag 精确匹配 + fallback 全量再 cap | 缺 RELiC 式证据检索 | **缺口** |
| 拒写无证据描写 | 全空感官可报错；action 仍可空描写输出 | 部分对齐；action 可能 AI 因果粘合 | **缺口** |
| 输出 groundedness 指标 | 无 quote density KPI | 缺 verify 仪表 | **缺口** |
...
见会话 `goal/research-sources.md`（查询列表与 URL）。

## 附录 B — 关键链接速查

- RELiC paper: https://aclanthology.org/2022.acl-long.517/  
- RELiC site: https://relic.cs.umass.edu/  
- LangExtract: https://github.com/google/langextract  
- CAT-LLM: https://github.com/taozhen1110/cat-llm  
